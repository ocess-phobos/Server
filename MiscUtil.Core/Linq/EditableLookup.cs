...
namespace MiscUtil.Core.Linq
{
    ...
    public sealed partial class EditableLookup<TKey, TElement> : ILookup<TKey, TElement>
    {
        ...
        {
            this.groups = new Dictionary<TKey, LookupGrouping>(
        ...
        public bool Contains(TKey key)
        {
            ...
            return this.groups.TryGetValue(key, out group) ? group.Count > 0 : false;
        }
        /// <summary>
        ...
        {
            LookupGrouping group;
            return this.groups.TryGetValue(key, out group) ? group.Contains(value) : false;
        }
        /// <summary>
