...
namespace MiscUtil.Core.Linq.Extensions
{
    public static partial class DataProducerExt
    {
        ...
        public static IDataProducer<TSource> Where<TSource>(this IDataProducer<TSource> source, DotNet20.Func<TSource, bool> predicate)
        {
