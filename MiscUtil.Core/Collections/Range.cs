...
namespace MiscUtil.Core.Collections
{
    ...
    public sealed class Range<T>
    {
        ...
        public Range<T> ExcludeEnd()
        {
            ...
            return new Range<T>(this.start, this.end, this.comparer, this.includesStart, false);
        }
        ...
        {
            if (!this.includesStart)
            {
                return this;
            }
            return new Range<T>(this.start, this.end, this.comparer, false, this.includesEnd);
        }
        ...
        public Range<T> IncludeEnd()
        {
            ...
            return new Range<T>(this.start, this.end, this.comparer, this.includesStart, true);
        }
        ...
        public Range<T> IncludeStart()
        {
            ...
            return new Range<T>(this.start, this.end, this.comparer, true, this.includesEnd);
        }
        ...
        {
            int lowerBound = this.comparer.Compare(value, this.start);
            if (lowerBound < 0 || (lowerBound == 0 && !this.includesStart))
            {
                return false;
            }
            int upperBound = this.comparer.Compare(value, this.end);
