...
namespace MiscUtil.Core.Text
{
	...
	public sealed class Utf32String : IEnumerable, IComparable, ICloneable
	{
		...
		{
			get { return this.characters[index]; }
		}
		#endregion
		...
		public override string ToString()
		{
			...
			char[] utf16 = new char[this.Length+surrogates];
			int outputIndex = 0;
			foreach (int character in this.characters)
			{
		...
		{
			int hash = 0;
			int step = Math.Max(this.Length / HashcodeSampleSize, 1);
