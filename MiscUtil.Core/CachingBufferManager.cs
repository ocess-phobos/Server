...
namespace MiscUtil.Core
{
    ...
    public sealed class CachingBufferManager : IBufferManager
    {
        ...
        public IBuffer GetBuffer(int minimumSize)
        {
            ...
            // cached buffers
            int listIndex = 0;
            int size = this.options.MinBufferSize;
        ...
        CachedBuffer FindAvailableBuffer(int listIndex, int size)
        {
            using (this.padlock.Lock())
            {
                ...
                for (int i = 0; i < buffers.Length; i++)
                {
                    ...
                    if (buffers[i] == null)
                    {
                        buffers[i] = new CachedBuffer(size, this.options.ClearAfterUse);
                        return buffers[i];
                    }
        ...
        public sealed class Options : ICloneable
        {
            ...
            { 
                get { return this.maxBuffersPerSizeBand; } 
                set
                {
                    if (value < 1)
                    {
                    ...
                    this.maxBuffersPerSizeBand = value;
                }
            }
            ...
            {
                get { return this.clearAfterUse; }
                set { this.clearAfterUse = value; }
            }
            ...
            {
                get { return this.actionOnBufferUnavailable; }
                set
                {
                    ...
                    this.actionOnBufferUnavailable = value;
                }
            }
